...
pub unsafe fn cpu_read_reg(rt: RegType) -> u16 {
    ...
    match rt {
        ...
        RegType::RT_AF => ((ctx.regs.a as u16) << 8) | (ctx.regs.f as u16),
        RegType::RT_BC => ((ctx.regs.b as u16) << 8) | (ctx.regs.c as u16),
        RegType::RT_DE => ((ctx.regs.d as u16) << 8) | (ctx.regs.e as u16),
        RegType::RT_HL => ((ctx.regs.h as u16) << 8) | (ctx.regs.l as u16),
